...
module.exports = {
  siteMetadata: {
    title: 'Scott Basmadjian',
    author: 'Scott Basmadjian',
    image: 'https://scottbasmadjian.com/avatar.jpg',
    description: 'Discoveries and rants of a developer while developing stuff',
    siteUrl: 'https://scottbasmadjian.com/',
    social: {
      twitter: 'scottbasmadjian',
    },
    organization: {
      name: 'Scott Basmadjian',
      url: 'https://Scottbasmadjian.com',
      logo: 'https://scottbasmadjian.com/logo.png',
    },
  },
  pathPrefix: '/',
  plugins: [
